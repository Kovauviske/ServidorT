...
life_event = true;
_message = "This is not a test. This is your emergency broadcast system announcing the commencement of the Annual Purge sanctioned by the INSERT SERVER NAME HERE Government. If you do not want to participate, leave the city and run to the outskirts or stay in a small room inside your house. All Emergency Services must end their shift and go home.";
